...
const environments = {
  ...
  production: {
    ...
    pool: {
      min: parseInt(process.env.DATABASE_API_CONNECTION_POOL_MIN_SIZE, 10) || 1,
      max: parseInt(process.env.DATABASE_API_CONNECTION_POOL_MAX_SIZE, 10) || 1,
    },
    asyncStackTraces: process.env.KNEX_ASYNC_STACKTRACE_ENABLED_API !== 'false',
  },
};
